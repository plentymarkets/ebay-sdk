...
/**
 *
 * @property \EbaySdk\Api\Taxonomy\Enums\MarketplaceIdEnum[] $applicableMarketplaceIds
 * @property string $categoryTreeId
 * @property string $categoryTreeVersion
 * @property \EbaySdk\Api\Taxonomy\Types\CategoryTreeNode $rootCategoryNode
 */
class CategoryTree extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
