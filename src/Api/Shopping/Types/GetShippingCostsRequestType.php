 ...
 * @property \EbaySdk\Shopping\Enums\CountryCodeType $DestinationCountryCode
 * @property boolean $IncludeDetails
 */
class GetShippingCostsRequestType extends \EbaySdk\Api\Shopping\Types\AbstractRequestType
{
    /**
