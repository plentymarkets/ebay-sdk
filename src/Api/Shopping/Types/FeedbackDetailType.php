 ...
 * @property \EbaySdk\Shopping\Enums\CommentTypeCodeType $CommentType
 * @property string $FeedbackResponse
 * @property string $FollowUp
 * @property string $ItemID
 * @property \EbaySdk\Shopping\Enums\TradingRoleCodeType $Role
 * @property string $ItemTitle
 * @property \EbaySdk\Shopping\Types\AmountType $ItemPrice
