 ...
 */
class ProductBaseService extends BaseWsdlService
{
	/**
	...
	protected static $endPoints = [
		'sandbox'    => 'https://svcs.sandbox.ebay.com/services/marketplacecatalog/ProductService/v1',
		'production' => 'https://svcs.ebay.com/services/marketplacecatalog/ProductService/v1'
	];
