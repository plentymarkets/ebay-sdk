 ...
 * @property \EbaySdk\Api\Trading\Enums\PictureSetCodeType $PictureSet
 * @property \EbaySdk\Api\Trading\Types\Base64BinaryType $PictureData
 * @property \EbaySdk\Api\Trading\Enums\PictureUploadPolicyCodeType $PictureUploadPolicy
 * @property string[] $ExternalPictureURL
 * @property integer $ExtensionInDays
 */
class UploadSiteHostedPicturesRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'PictureData' => [
            'type' => 'EbaySdk\Api\Trading\Types\Base64BinaryType',
            'repeatable' => false,
            'attribute' => false,
