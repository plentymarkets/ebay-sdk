 ...
 * @property \EbaySdk\Api\Trading\Types\AmountType $ConvertedBuyItNowPrice
 * @property \EbaySdk\Api\Trading\Types\AmountType $ConvertedStartPrice
 * @property \EbaySdk\Api\Trading\Types\AmountType $ConvertedReservePrice
 ...
 * @property \EbaySdk\Api\Trading\Types\AmountType $MinimumBestOfferPrice
 * @property string $LocalListingDistance
 * @property string $TCROriginalItemID
 * @property string $ViewItemURLForNaturalSearch
 * @property \EbaySdk\Api\Trading\Types\AmountType $BestOfferAutoAcceptPrice
 * @property \EbaySdk\Api\Trading\Enums\EndReasonCodeType $EndingReason
 */
class ListingDetailsType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
