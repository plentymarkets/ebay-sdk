 ...
 * @property \EbaySdk\Trading\Types\AmountType $BidIncrement
 * @property \EbaySdk\Trading\Types\AmountType $ConvertedCurrentPrice
 * @property \EbaySdk\Trading\Types\AmountType $CurrentPrice
 * @property \EbaySdk\Trading\Types\UserType $HighBidder
 * @property integer $LeadCount
 * @property \EbaySdk\Trading\Types\AmountType $MinimumToBid
 * @property integer $QuantitySold
 * @property boolean $ReserveMet
 * @property boolean $SecondChanceEligible
 * @property integer $BidderCount
 * @property \EbaySdk\Trading\Enums\ListingStatusCodeType $ListingStatus
 * @property \EbaySdk\Trading\Types\AmountType $FinalValueFee
 * @property \EbaySdk\Trading\Types\PromotionalSaleDetailsType $PromotionalSaleDetails
 * @property boolean $AdminEnded
 * @property boolean $SoldAsBin
 * @property integer $QuantitySoldByPickupInStore
 * @property \EbaySdk\Trading\Types\SuggestedBidValueType $SuggestedBidValues
 */
class SellingStatusType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'PromotionalSaleDetails' => [
            'type' => 'EbaySdk\Trading\Types\PromotionalSaleDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'SuggestedBidValues' => [
            'type' => 'EbaySdk\Trading\Types\SuggestedBidValueType',
            'repeatable' => false,
            'attribute' => false,
