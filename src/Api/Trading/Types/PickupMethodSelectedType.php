 ...
 * @property \EbaySdk\Api\Trading\Enums\PickupStatusCodeType $PickupStatus
 * @property string $MerchantPickupCode
 * @property \DateTime $PickupFulfillmentTime
 * @property string $PickupLocationUUID
 */
class PickupMethodSelectedType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
