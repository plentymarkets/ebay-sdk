 ...
 * @property \EbaySdk\Api\Trading\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \EbaySdk\Api\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \EbaySdk\Api\Trading\Enums\SiteCodeType $Site
 * @property \EbaySdk\Api\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \EbaySdk\Api\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \EbaySdk\Api\Trading\Types\BuyerType $BuyerInfo
 * @property \EbaySdk\Api\Trading\Types\SellerType $SellerInfo
 * @property \EbaySdk\Api\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \EbaySdk\Api\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \EbaySdk\Api\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \EbaySdk\Api\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \EbaySdk\Api\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 ...
 * @property \EbaySdk\Api\Trading\Types\BiddingSummaryType $BiddingSummary
 ...
 */
class UserType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'EbaySdk\Api\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'EbaySdk\Api\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'EbaySdk\Api\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
