 ...
 * @property \EbaySdk\Trading\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \EbaySdk\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \EbaySdk\Trading\Enums\SiteCodeType $Site
 * @property \EbaySdk\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \EbaySdk\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \EbaySdk\Trading\Types\BuyerType $BuyerInfo
 * @property \EbaySdk\Trading\Types\SellerType $SellerInfo
 * @property \EbaySdk\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \EbaySdk\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \EbaySdk\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \EbaySdk\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \EbaySdk\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 ...
 * @property \EbaySdk\Trading\Types\BiddingSummaryType $BiddingSummary
...
class UserType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'EbaySdk\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'EbaySdk\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'EbaySdk\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
