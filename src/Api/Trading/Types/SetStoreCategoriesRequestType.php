...
/**
 *
 * @property \EbaySdk\Trading\Enums\StoreCategoryUpdateActionCodeType $Action
 * @property integer $ItemDestinationCategoryID
 * @property integer $DestinationParentCategoryID
 * @property \EbaySdk\Trading\Types\StoreCustomCategoryArrayType $StoreCategories
 */
class SetStoreCategoriesRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
