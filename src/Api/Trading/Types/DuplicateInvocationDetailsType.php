 ...
 * @property \EbaySdk\Api\Trading\Enums\InvocationStatusType $Status
 * @property string $InvocationTrackingID
 */
class DuplicateInvocationDetailsType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
