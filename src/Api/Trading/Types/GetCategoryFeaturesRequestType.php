 ...
 * @property \EbaySdk\Api\Trading\Enums\FeatureIDCodeType[] $FeatureID
 * @property boolean $AllFeaturesForCategory
 */
class GetCategoryFeaturesRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
