...
/**
 *
 * @property \EbaySdk\Trading\Types\ListingDurationReferenceType[] $ListingDuration
 ...
 * @property \EbaySdk\Trading\Enums\AdFormatEnabledCodeType $AdFormatEnabled
 ...
 * @property \EbaySdk\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $ClassifiedAdPaymentMethodEnabled
 * @property boolean $ClassifiedAdShippingMethodEnabled
 * @property \EbaySdk\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $ClassifiedAdBestOfferEnabled
 ...
 * @property \EbaySdk\Trading\Enums\ItemSpecificsEnabledCodeType $ItemSpecificsEnabled
 ...
 * @property \EbaySdk\Trading\Enums\INEscrowWorkflowTimelineCodeType $INEscrowWorkflowTimeline
 * @property \EbaySdk\Trading\Types\ListingEnhancementDurationReferenceType $GalleryFeaturedDurations
 * @property boolean $PayPalRequired
 * @property \EbaySdk\Trading\Enums\AdFormatEnabledCodeType $eBayMotorsProAdFormatEnabled
 ...
 * @property \EbaySdk\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $eBayMotorsProBestOfferEnabled
 * @property boolean $eBayMotorsProAutoAcceptEnabled
 * @property boolean $eBayMotorsProAutoDeclineEnabled
 * @property \EbaySdk\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $eBayMotorsProPaymentMethodCheckOutEnabled
 ...
 * @property \EbaySdk\Trading\Enums\AdFormatEnabledCodeType $LocalMarketAdFormatEnabled
 ...
 * @property \EbaySdk\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $LocalMarketBestOfferEnabled
 * @property boolean $LocalMarketAutoAcceptEnabled
 * @property boolean $LocalMarketAutoDeclineEnabled
 * @property \EbaySdk\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $LocalMarketPaymentMethodCheckOutEnabled
 ...
 * @property \EbaySdk\Trading\Enums\GeographicExposureCodeType $SpecialitySubscription
 * @property \EbaySdk\Trading\Enums\GeographicExposureCodeType $RegularSubscription
 * @property \EbaySdk\Trading\Enums\GeographicExposureCodeType $PremiumSubscription
 * @property \EbaySdk\Trading\Enums\GeographicExposureCodeType $NonSubscription
 ...
 * @property \EbaySdk\Trading\Types\StoreOwnerExtendedListingDurationsType $StoreOwnerExtendedListingDurations
 * @property boolean $ReturnPolicyEnabled
 * @property boolean $HandlingTimeEnabled
 * @property \EbaySdk\Trading\Types\AmountType $MaxFlatShippingCost
 * @property boolean $MaxFlatShippingCostCBTExempt
 * @property \EbaySdk\Trading\Types\AmountType $Group1MaxFlatShippingCost
 * @property \EbaySdk\Trading\Types\AmountType $Group2MaxFlatShippingCost
 * @property \EbaySdk\Trading\Types\AmountType $Group3MaxFlatShippingCost
 ...
 * @property \EbaySdk\Trading\Enums\ItemCompatibilityEnabledCodeType $ItemCompatibilityEnabled
 * @property integer $MinItemCompatibility
 * @property integer $MaxItemCompatibility
 * @property \EbaySdk\Trading\Enums\ConditionEnabledCodeType $ConditionEnabled
 * @property \EbaySdk\Trading\Types\ConditionValuesType $ConditionValues
 * @property boolean $ValueCategory
 * @property \EbaySdk\Trading\Enums\ProductCreationEnabledCodeType $ProductCreationEnabled
 * @property \EbaySdk\Trading\Enums\ProductIdentiferEnabledCodeType $EANEnabled
 * @property \EbaySdk\Trading\Enums\ProductIdentiferEnabledCodeType $ISBNEnabled
 * @property \EbaySdk\Trading\Enums\ProductIdentiferEnabledCodeType $UPCEnabled
 * @property integer $MaxGranularFitmentCount
 * @property string $CompatibleVehicleType
 * @property \EbaySdk\Trading\Enums\PaymentOptionsGroupEnabledCodeType $PaymentOptionsGroup
 * @property \EbaySdk\Trading\Enums\ProfileCategoryGroupCodeType $ShippingProfileCategoryGroup
 * @property \EbaySdk\Trading\Enums\ProfileCategoryGroupCodeType $PaymentProfileCategoryGroup
 * @property \EbaySdk\Trading\Enums\ProfileCategoryGroupCodeType $ReturnPolicyProfileCategoryGroup
...
class SiteDefaultsType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'ListingDuration' => [
            'type' => 'EbaySdk\Trading\Types\ListingDurationReferenceType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'GalleryFeaturedDurations' => [
            'type' => 'EbaySdk\Trading\Types\ListingEnhancementDurationReferenceType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'StoreOwnerExtendedListingDurations' => [
            'type' => 'EbaySdk\Trading\Types\StoreOwnerExtendedListingDurationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ConditionValues' => [
            'type' => 'EbaySdk\Trading\Types\ConditionValuesType',
            'repeatable' => false,
            'attribute' => false,
