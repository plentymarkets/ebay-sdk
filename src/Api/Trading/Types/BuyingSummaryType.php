 ...
 * @property \EbaySdk\Api\Trading\Types\AmountType $TotalWinningCost
 * @property integer $WonCount
 * @property \EbaySdk\Api\Trading\Types\AmountType $TotalWonCost
 * @property integer $WonDurationInDays
 * @property integer $BestOfferCount
 */
class BuyingSummaryType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
