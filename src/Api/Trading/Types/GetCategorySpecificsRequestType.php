 ...
 * @property \EbaySdk\Api\Trading\Types\CategoryItemSpecificsType[] $CategorySpecific
 * @property boolean $ExcludeRelationships
 * @property boolean $IncludeConfidence
 * @property boolean $CategorySpecificsFileInfo
 */
class GetCategorySpecificsRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'CategorySpecific' => [
            'type' => 'EbaySdk\Api\Trading\Types\CategoryItemSpecificsType',
            'repeatable' => true,
            'attribute' => false,
