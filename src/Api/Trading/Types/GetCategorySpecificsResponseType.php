...
/**
 *
 * @property \EbaySdk\Api\Trading\Types\RecommendationsType[] $Recommendations
 * @property string $TaskReferenceID
 * @property string $FileReferenceID
 */
class GetCategorySpecificsResponseType extends \EbaySdk\Api\Trading\Types\AbstractResponseType
{
    /**
    ...
    private static $propertyTypes = [
        'Recommendations' => [
            'type' => 'EbaySdk\Api\Trading\Types\RecommendationsType',
            'repeatable' => true,
            'attribute' => false,
