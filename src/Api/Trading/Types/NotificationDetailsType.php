 ...
 * @property \EbaySdk\Api\Trading\Enums\NotificationEventTypeCodeType $Type
 * @property integer $Retries
 * @property \EbaySdk\Api\Trading\Enums\NotificationEventStateCodeType $DeliveryStatus
 * @property \DateTime $NextRetryTime
 * @property \DateTime $DeliveryTime
 * @property string $ErrorMessage
 * @property string $DeliveryURLName
 */
class NotificationDetailsType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
