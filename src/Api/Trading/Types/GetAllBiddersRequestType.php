 ...
 * @property \EbaySdk\Api\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
