 ...
 * @property \EbaySdk\Api\Trading\Enums\CommentTypeCodeType $CommentType
 * @property string $TransactionID
 * @property string $TargetUser
 * @property \EbaySdk\Api\Trading\Types\ItemRatingDetailArrayType $SellerItemRatingDetailArray
 * @property string $OrderLineItemID
 * @property \EbaySdk\Api\Trading\Enums\ItemArrivedWithinEDDCodeType $ItemArrivedWithinEDDType
 * @property boolean $ItemDeliveredWithinEDD
 */
class LeaveFeedbackRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SellerItemRatingDetailArray' => [
            'type' => 'EbaySdk\Api\Trading\Types\ItemRatingDetailArrayType',
            'repeatable' => false,
            'attribute' => false,
