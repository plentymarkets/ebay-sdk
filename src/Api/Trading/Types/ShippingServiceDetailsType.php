 ...
 * @property \EbaySdk\Trading\Enums\ShippingServiceCodeType $ShippingServiceCode
 * @property \EbaySdk\Trading\Enums\ShippingTypeCodeType[] $ServiceType
 ...
 * @property \EbaySdk\Trading\Enums\ShippingCarrierCodeType[] $ShippingCarrier
 * @property boolean $CODService
 * @property \EbaySdk\Trading\Types\AnnouncementMessageType[] $DeprecationDetails
 * @property integer $MappedToShippingServiceID
 * @property string $CostGroupFlat
 * @property \EbaySdk\Trading\Types\ShippingServicePackageDetailsType[] $ShippingServicePackageDetails
 * @property boolean $WeightRequired
 * @property string $DetailVersion
 * @property \DateTime $UpdateTime
 * @property string $ShippingCategory
 */
class ShippingServiceDetailsType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'DeprecationDetails' => [
            'type' => 'EbaySdk\Trading\Types\AnnouncementMessageType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'ShippingServicePackageDetails' => [
            'type' => 'EbaySdk\Trading\Types\ShippingServicePackageDetailsType',
            'repeatable' => true,
            'attribute' => false,
