 ...
 * @property \EbaySdk\Trading\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \EbaySdk\Trading\Enums\SellerLevelCodeType $SellerLevel
 * @property \EbaySdk\Trading\Types\AddressType $SellerPaymentAddress
 * @property \EbaySdk\Trading\Types\SchedulingInfoType $SchedulingInfo
 ...
 * @property \EbaySdk\Trading\Enums\SiteCodeType $StoreSite
 ...
 * @property \EbaySdk\Trading\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \EbaySdk\Trading\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \EbaySdk\Trading\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \EbaySdk\Trading\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \EbaySdk\Trading\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
...
class SellerType extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'EbaySdk\Trading\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'EbaySdk\Trading\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'EbaySdk\Trading\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'EbaySdk\Trading\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'EbaySdk\Trading\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'EbaySdk\Trading\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
