 ...
 * @property \EbaySdk\Api\Trading\Types\TimeRangeType $EmailDateRange
 * @property string $OrderLineItemID
 */
class GetSellingManagerEmailLogRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
