...
/**
 *
 * @property \EbaySdk\Api\Trading\Enums\MyMessagesFolderOperationCodeType $Operation
 * @property integer[] $FolderID
 * @property string[] $FolderName
 */
class ReviseMyMessagesFoldersRequestType extends \EbaySdk\Api\Trading\Types\AbstractRequestType
{
    /**
