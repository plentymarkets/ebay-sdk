 ...
 * @property \EbaySdk\BusinessPoliciesManagement\Enums\ProfileType $profileType
 * @property integer $profileVersion
 * @property string $profileDesc
 * @property \DateTime $deletedDate
 * @property integer $siteId
 * @property \EbaySdk\BusinessPoliciesManagement\Types\CategoryGroups $categoryGroups
 */
class SellerProfile extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'categoryGroups' => [
            'type' => 'EbaySdk\BusinessPoliciesManagement\Types\CategoryGroups',
            'repeatable' => false,
            'attribute' => false,
