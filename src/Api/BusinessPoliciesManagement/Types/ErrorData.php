 ...
 * @property \EbaySdk\BusinessPoliciesManagement\Enums\ErrorSeverity $severity
 * @property \EbaySdk\BusinessPoliciesManagement\Enums\ErrorCategory $category
 * @property string $message
 * @property string $exceptionId
 * @property \EbaySdk\BusinessPoliciesManagement\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'EbaySdk\BusinessPoliciesManagement\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
