 ...
 * @property \EbaySdk\BusinessPoliciesManagement\Types\Amount $shippingOverrideFee
 * @property boolean $buyerResponsibleForShipping
 */
class ShippingPolicyService extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
