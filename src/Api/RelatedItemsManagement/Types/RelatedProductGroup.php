...
/**
 *
 * @property \EbaySdk\Api\RelatedItemsManagement\Types\RelatedProduct[] $relatedProduct
 * @property string $groupName
 * @property integer $rank
 * @property boolean $singleRelatedSKUPurchaseOnly
 */
class RelatedProductGroup extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'relatedProduct' => [
            'type' => 'EbaySdk\Api\RelatedItemsManagement\Types\RelatedProduct',
            'repeatable' => true,
            'attribute' => false,
