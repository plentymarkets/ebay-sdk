 ...
 */
class HalfFindingBaseService extends BaseWsdlService
{
	/**
	...
	protected static $endPoints = [
		'sandbox'    => 'http://svcs.ebay.com/services/half/HalfFindingService/v1',
		'production' => 'https://svcs.ebay.com/services/half/HalfFindingService/v1'
	];
