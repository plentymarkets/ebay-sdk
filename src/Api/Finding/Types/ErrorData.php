 ...
 * @property \EbaySdk\Finding\Enums\ErrorSeverity $severity
 * @property \EbaySdk\Finding\Enums\ErrorCategory $category
 * @property string $message
 * @property string $subdomain
 * @property string $exceptionId
 * @property \EbaySdk\Finding\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'EbaySdk\Finding\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
