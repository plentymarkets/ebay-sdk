 ...
 * @property \EbaySdk\Finding\Types\Amount $buyItNowPrice
 * @property \EbaySdk\Finding\Types\Amount $convertedBuyItNowPrice
 * @property \DateTime $startTime
 * @property \DateTime $endTime
 * @property string $listingType
 * @property boolean $gift
 */
class ListingInfo extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    /**
