 ...
 */
class ResolutionCaseManagementBaseService extends BaseWsdlService
{
	/**
	...
	protected static $endPoints = [
		'sandbox'    => 'https://svcs.sandbox.ebay.com/services/resolution/v1/ResolutionCaseManagementService',
		'production' => 'https://svcs.ebay.com/services/resolution/v1/ResolutionCaseManagementService'
	];
