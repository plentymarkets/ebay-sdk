 ...
 * @property \EbaySdk\ResolutionCaseManagement\Enums\AppealReasonType $appealReason
 * @property string $comments
 */
class AppealToCustomerSupportRequest extends \EbaySdk\Api\ResolutionCaseManagement\Types\BaseRequest
{
    /**
