 ...
 */
class GetListingsInSpecificPromotionRestResponse extends \EbaySdk\Api\Marketing\Types\ItemsPagedCollection
{
    use StatusCodeTrait;
    ...
    public function __construct(array $values = [], $statusCode = 200, array $headers = [])
    {
        ...
        if (!array_key_exists(__CLASS__, self::$properties)) {
            self::$properties[__CLASS__] = array_merge(self::$properties[\EbaySdk\Api\Marketing\Types\ItemsPagedCollection::class], self::$propertyTypes);
        }
