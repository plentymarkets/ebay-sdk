 ...
 */
class GetReturnRuleTemplatesRestResponse extends \EbaySdk\Api\PostOrder\Types\GetDispositionRuleTemplatesResponse
{
    use StatusCodeTrait;
    ...
    public function __construct(array $values = [], $statusCode = 200, array $headers = [])
    {
        ...
        if (!array_key_exists(__CLASS__, self::$properties)) {
            self::$properties[__CLASS__] = array_merge(self::$properties[\EbaySdk\Api\PostOrder\Types\GetDispositionRuleTemplatesResponse::class], self::$propertyTypes);
        }
