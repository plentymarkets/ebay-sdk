 ...
 */
class SubmitReturnFileRestResponse extends \EbaySdk\Api\PostOrder\Types\SubmitFileResponse
{
    use StatusCodeTrait;
    ...
    public function __construct(array $values = [], $statusCode = 200, array $headers = [])
    {
        ...
        if (!array_key_exists(__CLASS__, self::$properties)) {
            self::$properties[__CLASS__] = array_merge(self::$properties[\EbaySdk\Api\PostOrder\Types\SubmitFileResponse::class], self::$propertyTypes);
        }
