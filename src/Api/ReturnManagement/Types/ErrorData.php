 ...
 * @property \EbaySdk\ReturnManagement\Enums\ErrorSeverity $severity
 * @property \EbaySdk\ReturnManagement\Enums\ErrorCategory $category
 * @property string $message
 * @property string $exceptionId
 * @property \EbaySdk\ReturnManagement\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \Plenty\Modules\Market\Ebay\Api\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'EbaySdk\ReturnManagement\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
