 ...
 */
class ProductMetadataBaseService extends BaseWsdlService
{
	/**
	...
	protected static $endPoints = [
		'sandbox'    => 'http://svcs.sandbox.ebay.com/services/marketplacecatalog/ProductMetadataService/v1',
		'production' => 'http://svcs.ebay.com/services/marketplacecatalog/ProductMetadataService/v1'
	];
